...
banda=8;
    ...
    elseif(banda==5) %beta1
         frec='beta1';
        FRANGE=[12:0.5:22];
        colorBar=[0.07 0.37];        %norm2
    elseif(banda==6) %beta2
         frec='beta2';
        FRANGE=[22:0.5:35];
        colorBar=[0.1 0.28];       %norm2
...
for j=1:4 %condiciones    
    ...
    for i=1:20
            load(['D:\EEG\priming48hs\fft\cond_',num2str(j),'\',frec,'\t2Norm2\s',num2str(i),'.mat']); 
