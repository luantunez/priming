    ...
    for k=1:4  %condiciones

        suj1=load(['D:\EEG\priming48hs\fft\ERPtotSujCond\cond_',num2str(k),'\',frec,'\t1\sujPmedio.mat']); %baseline
        ...
        suj2=load(['D:\EEG\priming48hs\fft\ERPtotSujCond\cond_',num2str(k),'\',frec,'\t2\sujPmedio.mat']); %priming
        Rho2=suj2.Rho2;
        ...
        save(['D:\EEG\priming48hs\fft\ERPtotSujCond\cond_',num2str(k),'\',frec,'\t2Norm\sujPmedio.mat'],'RhoP2','Phi2','EjeX2','EjeF2');
