...
%para antes
ind1=[1:51];
TRANGE1=[0:sujTimesPmedioCond(ind1(1))*(-1)]; %porque los primeros 51 numeros estan en negativo (los anteriores)
%para despues
ind2=[52:307];
TRANGE2=[0:sujTimesPmedioCond(ind2(end))];

%para tiempos antes
SIG1=sujDatosPmedioCond(:,1:51);
[Rho1, Phi1, EjeX1, EjeF1] = espectrograma2( SIG1, FE, FRANGE, TRANGE1, WinSig, step);
save(['D:\EEG\priming48hs\fft\ERPtotSuj\',frec,'\t1\sujPmedio.mat'],'Rho1','Phi1','EjeX1','EjeF1');

%para tiempos despues
SIG2=sujDatosPmedioCond(:,51:307);
[Rho2, Phi2, EjeX2, EjeF2] = espectrograma2( SIG2, FE, FRANGE, TRANGE2, WinSig, step);
save(['D:\EEG\priming48hs\fft\ERPtotSuj\',frec,'\t2\sujPmedio.mat'],'Rho2','Phi2','EjeX2','EjeF2');
