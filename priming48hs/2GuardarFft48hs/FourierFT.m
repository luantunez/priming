    ...
    for i=1:4 %condiciones
        for j=1:20 %sujetos
            ...
            for k=1:size(suj.datos,3) %epocas
                ...
                %RhoP1=squeeze(Rho1);
                %suj(j)=RhoP1;
                save(['D:\EEG\priming48hs\fft\cond_',num2str(i),'\',frec,'\t1\s',num2str(j),'.mat'],'Rho1','Phi1','EjeX1','EjeF1');
               ...
               save(['D:\EEG\priming48hs\fft\cond_',num2str(i),'\',frec,'\t2\s',num2str(j),'.mat'],'Rho2','Phi2','EjeX2','EjeF2');
                %RhoP2=squeeze(Rho2);
                %suj(j)=RhoP2;
            end
        end
