%normalizo respecto a la mitad del tiempo del baseline
...
for banda=1:8
    ...
    for i=1:4 %condiciones
        ...
        for j=1:20 %sujetos
            suj1=load(['D:\EEG\priming48hs\fft\cond_',num2str(i),'\',frec,'\t1\s',num2str(j),'.mat']); %baseline
            ...
            suj2=load(['D:\EEG\priming48hs\fft\cond_',num2str(i),'\',frec,'\t2\s',num2str(j),'.mat']); %priming
            Rho2=suj2.Rho2;
            ...
            save(['D:\EEG\priming48hs\fft\cond_',num2str(i),'\',frec,'\t2Norm2\s',num2str(j),'.mat'],'RhoP2','Phi2','EjeX2','EjeF2');
        end
    end
